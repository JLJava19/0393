	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item "><a class="nav-link active" href="index.jsp">Home
					<span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item active"><a class="nav-link" href="componentes.jsp">Componentes
				</a></li>
				<li class="nav-item"><a class="nav-link" href="utilidades.jsp">Utilidades
				</a></li>
				<li class="nav-item"><a class="nav-link" href="grid.jsp">Grid System
				</a></li>
				<li class="nav-item"><a class="nav-link" href="pagina-completa.jsp">Página
				</a></li>
				<li class="nav-item"><a class="nav-link" href="theme.jsp">Theme
				</a></li>
